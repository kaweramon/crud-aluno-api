describe("teste1", function () {
    ...
    it("deve fazer login", function () {
        ...
        element(by.id("loginInputUsername")).sendKeys("admin");
        element(by.id("loginInputPassword")).sendKeys("admin");
        element(by.id("btnFazerLogin")).click();
    });

    it("Deve salvar um aluno", function () {
        browser.get("http://localhost:8080/#!/view1");
